...
public class DemoThreadPool {
    public static void main(String[] args) {
        // 1. 使用线程池的工厂类Executors里面提供的静态方法newFixedThreadPool生成一个指定线程数量的线程池
        // 静态方法newFixedThreadPool返回的是线程池的实现类，用ExecutorService来接收
        ExecutorService es = Executors.newFixedThreadPool(2);
        // 3. 调用ExecutorService中的方法submit，传递线程任务（实现类对象），开启线程，执行run方法
        ...
        es.submit(new RunnableImpl()); // 抛异常，线程池已经被销毁，就不能获取线程了
    }
}
